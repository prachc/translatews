			...
			public void run() {
				...
				mHandler = new Handler() {
					...
					public void handleMessage(Message msg){
						...
						Bundle tempBundle1,tempBundle2,tempBundle3,tempBundle4;
						String[] tempArray;
						switch (msg.what) {
						case WS_TranslateJP_SUCCEED:
							stopThread(threadTranslateJP);
							
		                	tempBundle1 = replyTranslateJP.readBundle();
		                	tempArray = tempBundle1.getStringArray("WordJP");
		                	TranslateJP_Word = tempArray[0];
		                	
		                	System.out.println("T1_TIME:"+getTimeStamp());
		                	Synchronize_1_TranslateJP = true;
							
							if(Synchronize_1_TranslateJP&&Synchronize_1_TranslateZH&&Synchronize_1_TranslateFR&&Synchronize_1_TranslateES)
			        			mHandler.sendEmptyMessage(SYNCHRONIZE_1);
							else
								debug("TranslateJP finished, other=not yet");
							break;
						...
						case WS_TranslateZH_SUCCEED:
		                	...
		                	tempBundle2 = replyTranslateZH.readBundle();
		                	tempArray = tempBundle2.getStringArray("WordZH");
		                	TranslateZH_Word = tempArray[0];
		                	
		                	System.out.println("T2_TIME:"+getTimeStamp());
		                	Synchronize_1_TranslateZH = true;
							
							if(Synchronize_1_TranslateJP&&Synchronize_1_TranslateZH&&Synchronize_1_TranslateFR&&Synchronize_1_TranslateES)
			        			mHandler.sendEmptyMessage(SYNCHRONIZE_1);
							else
								debug("TranslateZH finished, other=not yet");
							break;
						...
						case WS_TranslateFR_SUCCEED:
		                	...
		                	tempBundle3 = replyTranslateFR.readBundle();
		                	tempArray = tempBundle3.getStringArray("WordFR");
		                	TranslateFR_Word = tempArray[0];
		                	
		                	System.out.println("T3_TIME:"+getTimeStamp());
		                	Synchronize_1_TranslateFR = true;
							
							if(Synchronize_1_TranslateJP&&Synchronize_1_TranslateZH&&Synchronize_1_TranslateFR&&Synchronize_1_TranslateES)
			        			mHandler.sendEmptyMessage(SYNCHRONIZE_1);
							else
								debug("TranslateFR finished, other=not yet");
							break;
						...
						case WS_TranslateES_SUCCEED:
		                	...
		                	tempBundle4 = replyTranslateES.readBundle();
		                	tempArray = tempBundle4.getStringArray("WordES");
		                	TranslateES_Word = tempArray[0];
		                	
		                	System.out.println("T4_TIME:"+getTimeStamp());
		                	Synchronize_1_TranslateES = true;
							
							if(Synchronize_1_TranslateJP&&Synchronize_1_TranslateZH&&Synchronize_1_TranslateFR&&Synchronize_1_TranslateES)
			        			mHandler.sendEmptyMessage(SYNCHRONIZE_1);
							else
								debug("TranslateES finished, other=not yet");
							break;
						case WS_TranslateES_FAILED:
							...
							break;
						case SYNCHRONIZE_1:
							Synchronize_1_TranslateJP = false;
							Synchronize_1_TranslateZH = false;
							Synchronize_1_TranslateFR = false;
							Synchronize_1_TranslateES = false;
						...
						case OUTPUT:
							...
							tempBundle1.putString("WordJP", TranslateJP_Word);
							tempBundle1.putString("WordZH", TranslateZH_Word);
							tempBundle1.putString("WordFR", TranslateFR_Word);
							tempBundle1.putString("WordES", TranslateES_Word);
